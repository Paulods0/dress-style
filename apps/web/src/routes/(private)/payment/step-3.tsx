  ...
  return (
    <div className='page-container'>
      <div className='flex flex-col gap-6 items-center justify-center'>
        ...
        <p className='w-full lg:w-[444px] text-justify'>
        ...
        <div className='flex flex-wrap items-center gap-4 w-full lg:w-[444px]'>
          <Button onClick={() => navigate({ to: '/' })} className='uppercase w-full lg:w-fit' variant={'outline'}>
            voltar ao catálogo
          </Button>
          <Button className='uppercase w-full lg:w-fit'>acompanhar a encomenda</Button>
        </div>
      </div>
    </div>
  );
